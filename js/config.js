...
window.CFG = {
  ...
  colors: {
    ...
    '관리비': '#94A3B8', '부모님 용돈': '#E6C97F', '금융': '#8FD3E8', '기타': '#6B7280', '미분류': '#6B7280',
  },
  groupColors: {
    '식사': '#F2A65A', '건강': '#57D6A9', '교통/통신': '#7FB4F2', '관계': '#E48BC0',
    '여가': '#A78BFA', '꾸미기': '#F27BA0', '주거': '#94A3B8', '가족': '#E6C97F', '금융': '#8FD3E8', '기타': '#6B7280',
  },
  icons: {
    ...
    '관리비': 'fa-house', '부모님 용돈': 'fa-heart', '금융': 'fa-building-columns', '기타': 'fa-circle-question', '미분류': 'fa-circle-question',
    '수입': 'fa-sack-dollar',
  },
